...
user_pref_file_from_main = os.getcwd() + "\\User_pref.jsonl"

#df = pd.read_json(filename, lines=True)
#df_user_pref = pd.read_json(user_pref_file, lines=True)
df = pd.read_json(filename_from_main, lines=True)
df_user_pref = pd.read_json(user_pref_file_from_main, lines=True)
...
def give_a_suggestion():
    ...
    print("The System offers those movies:\n ")
